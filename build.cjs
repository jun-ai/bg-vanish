...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === '/BingSiteAuth.xml') return new Response('<?xml version="1.0"?><users><user>ba1749d71fbc1c0df8b0735171ec5278</user></users>', {headers:{'Content-Type':'application/xml','Cache-Control':'public, max-age=86400'}});
    // Demo images
